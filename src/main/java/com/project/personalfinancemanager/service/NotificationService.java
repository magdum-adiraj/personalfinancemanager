...
public class NotificationService {
    ...
    @Value("${personal.finance.manager.frontend.url}")
    ...
    public void sendDailyIncomeExpenseReminder(){
        ...
        for(UserProfileEntity profile:profiles){
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    ...
                    + "<br><br>Best regards,<br>Personal Finance Manager Team";
        ...
        for(UserProfileEntity profile:profiles) {
            ...
            if(!expenses.isEmpty()){
                ...
                for(ExpenseDTO expense:expenses){
                    ...
                    table.append("<td style='border:1px solid #ddd;padding:8px;'>").append(expense.getCategoryId()!=null? expense.getCategoryName():"NA").append("</td>");
                    table.append("</tr>");
                }
                table.append("</table>");

                String body = "Hi "+profile.getFullName()+",<br/><br/> Here is a summary of your expenses for today:"
                        + table + "<br><br>Best regards,<br>Personal Finance Manager Team";
